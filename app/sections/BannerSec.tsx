...
const Banner: React.FC = () => {
    return (
        <section className='py-10 md:pt-10 pt-0 overflow-hidden relative' id="banner">
            {/* <div className='flex justify-center absolute left-1/12 top-1/6'>
                <img
                    src="/banner-text1.svg"
                ...
                <div className="flex justify-center flex-col">
                    <div className='w-full flex justify-center'>
                        <img
                            ...
                            className="object-contain w-auto max-w-[400px] sm:w-[500px] lg:w-[700px] h-auto"
                        />
                    </div>
